...
class _LineDefaultState extends State<CustomizedLine> {
  _LineDefaultState() {
    _xValues = <num>[];
    _yValues = <num>[];
    _xPointValues = <double>[];
    _yPointValues = <double>[];
  }
  ...
  SfCartesianChart _buildCartesianChart() {
    return SfCartesianChart(
      ...
      title: ChartTitle(
        text: 'Capital investment as a share of exports',
      ),
...
class _LineCustomPainter<T, D> extends LineSegment<T, D> {
  ...
  late List<num> _xValues;
  late List<num> _yValues;
  late List<double> _xPointValues;
  late List<double> _yPointValues;
  ...
  List<num> get xValues => _xValues;
  List<num> get yValues => _yValues;
  List<double> get xPointValues => _xPointValues;
  List<double> get yPointValues => _yPointValues;
