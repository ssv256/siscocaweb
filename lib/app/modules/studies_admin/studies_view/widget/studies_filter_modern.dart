...
import 'package:siscoca/app/modules/studies_admin/studies_view/controllers/studies_controller.dart';

class ModernStudiesFilter extends GetView<StudyAdminController> {
  const ModernStudiesFilter({super.key});
                    ...
                    child: Obx(() {
                      ...
                      return TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Search by title, description, hospital...',
                          prefixIcon: Icon(
                            Icons.search,
